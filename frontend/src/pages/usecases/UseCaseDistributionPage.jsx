...
export default function UseCaseDistributionPage() {
  ...
  return (
    <UseCasePageTemplate
      ...
      features={[
        { icon: <IconTrophy />, title: t(`${k}.feature1Title`), desc: t(`${k}.feature1Desc`) },
        { icon: <IconChart />, title: t(`${k}.feature2Title`), desc: t(`${k}.feature2Desc`) },
