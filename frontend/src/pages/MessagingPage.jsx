                ...
                >
                  <div onClick={() => openConversation(conv)} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 4 }}>
                      ...
                      {unread > 0 && <span style={{ background: '#6366f1', color: '#fff', fontSize: 11, fontWeight: 700, borderRadius: 10, padding: '1px 8px', marginLeft: 8, flexShrink: 0 }}>{unread}</span>}
                    </div>
                    {/* Partner name prominently displayed */}
                    {conv.partner_name && (
                      <div style={{ fontSize: 12, color: '#6366f1', fontWeight: 700, marginBottom: 4, display: 'flex', alignItems: 'center', gap: 4 }}>
              ...
              <div style={{ padding: '16px 24px', borderBottom: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  ...
                  {activeConv.partner_name && (
                    <div style={{ fontSize: 13, color: '#6366f1', fontWeight: 600, marginTop: 2, display: 'flex', alignItems: 'center', gap: 4 }}>
