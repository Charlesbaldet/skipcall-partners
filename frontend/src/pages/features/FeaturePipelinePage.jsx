...
export default function FeaturePipelinePage() {
  ...
  const d = t('features.pipeline', { returnObjects: true });
  const benefits = d.benefits.map((b, i) => ({ ...b, illustration: ILLUS[i] }));

  return (
    <FeaturePageTemplate
      helmet={{ title: d.helmet_title, description: d.helmet_desc, canonical: 'https://refboost.io/fonctionnalites/pipeline' }}
      accentColor="#059669"
