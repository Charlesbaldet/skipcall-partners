                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 8, overflowY: 'auto', minHeight: 0 }}>
                  {cards.map(c => (
                    <div key={c.id} style={{ background: '#fff', borderRadius: 12, padding: 14, border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
                      ...
                      {status === 'pending' && (
                        <button onClick={() => handleStatusChange(c.id, 'approved')} style={{ width: '100%', padding: '7px', borderRadius: 8, background: '#eef2ff', border: 'none', color: 'var(--rb-primary, #059669)', fontWeight: 600, fontSize: 12, cursor: 'pointer' }}>Approuver</button>
                      )}
                      {status === 'approved' && (
                ...
                return (
                  <tr key={c.id} style={{ borderBottom: '1px solid #f8fafc' }}>
                    ...
                    <td style={{ padding: '13px 16px' }}>
                      {c.status === 'pending' && <button onClick={() => handleStatusChange(c.id, 'approved')} style={{ padding: '6px 12px', borderRadius: 8, background: '#eef2ff', border: 'none', color: 'var(--rb-primary, #059669)', fontWeight: 600, fontSize: 12, cursor: 'pointer' }}>Approuver</button>}
          ...
          <div className="fade-in" style={{ position: 'relative', background: '#fff', borderRadius: 24, width: 480, maxWidth: '100%', boxShadow: '0 25px 80px rgba(0,0,0,0.25)', padding: 32 }}>
            ...
            <div style={{ background: '#f8fafc', borderRadius: 14, padding: 20, marginBottom: 20, border: '1px solid #e2e8f0' }}>
              ...
              <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: 16, display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
                ...
                <div><div style={{ color: '#94a3b8', fontSize: 11 }}>Taux</div><div style={{ fontWeight: 600, color: 'var(--rb-primary, #059669)', fontSize: 13 }}>{payModal.commission.rate}%</div></div>
              </div>
            </div>
