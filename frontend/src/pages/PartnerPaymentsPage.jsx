          ...
          {!editIban ? (
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <button onClick={handleSaveIban} disabled={savingIban} style={{
                display: 'flex', alignItems: 'center', gap: 4, padding: '8px 14px', borderRadius: 10,
                background: 'var(--rb-primary, #047857)', border: 'none', color: '#fff',
            ...
            {commissions.length === 0 ? (
              ...
              return (
                <tr key={c.id} style={{ borderBottom: '1px solid #f8fafc' }}>
                  ...
                  <td style={{ padding: '13px 16px' }}>
                    <span style={{ padding: '3px 8px', borderRadius: 6, background: '#eef2ff', color: 'var(--rb-primary, #047857)', fontWeight: 700, fontSize: 12 }}>{c.rate}%</span>
                  </td>
          ...
          {commissions.length > 0 && (
            <tfoot>
              <tr style={{ background: '#f8fafc' }}>
                ...
                <td style={{ padding: '13px 16px', fontWeight: 800, color: 'var(--rb-primary, #047857)', fontSize: 18 }}>{fmt(totalAll)}</td>
                <td colSpan={3}></td>
              </tr>
            </tfoot>
          )}
