...
const STATIC_PAGES = [
  ...
  { path: '/cas-dusage/reseau-distribution',    changefreq: 'monthly', priority: '0.8' },
  { path: '/cas-dusage/marketplace-plateforme', changefreq: 'monthly', priority: '0.8' },
  { path: '/cas-dusage/agence-marketing',       changefreq: 'monthly', priority: '0.8' },
